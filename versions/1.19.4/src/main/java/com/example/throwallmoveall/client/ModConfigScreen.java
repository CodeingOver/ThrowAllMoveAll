...
/**
 * ModConfigScreen — Version for Minecraft 1.19.4.
 * Uses ButtonWidget.builder() and DrawableHelper for 1.19.4 API changes.
 */
public class ModConfigScreen extends Screen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        DrawableHelper.drawCenteredTextWithShadow(matrices, this.textRenderer, this.title, cx, 18, COLOR_TITLE);
